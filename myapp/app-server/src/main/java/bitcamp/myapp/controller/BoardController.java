...
public class BoardController {
  ...
  //ServletContext는 요청 핸들러의 파라미터로 주입받을 수 없다.
  //객체의 필드로만 주입받을 수 있다.
  ...
  public String insert(
      Board board,    //도메인 프라퍼티명 =  클라에서 보내는 파라미터명 일 경우
      Part[] files,
      Model model,   // ServletRequest 보관소에 저장할 값을 담는 임시 저장소
      // 이 객체에 값을 담아두면 프론트 컨트롤러(DispatcherServlet)가
  ...
  @GetMapping("list")
  public String list(String keyword,Model model, HttpServletRequest request) {
