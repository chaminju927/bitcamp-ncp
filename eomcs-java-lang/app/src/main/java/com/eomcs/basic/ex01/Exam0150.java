...
public class Exam0150 {
  ...
  static class Student {
    ...
    public static void main(String[] args) {
      ...
      System.out.println(s1.hashCode()); //overriding안했으므로 넷다 해시코드 다름
      ...
      set.add(s1);  //여기 보관할 때는 해시코드가 낮은 순대로 보관됨
      set.add(s2);
      set.add(s3);
      set.add(s4);

      // 해시셋에 보관된 객체를( 배열에 담아 )꺼낸다.
      ...
      //   3) 단, 저장시 저장 위치는 hashCode()의 리턴값을 사용하여 계산한다.
