...
public class Exam0340 {
  ...
  public static void main(String[] args) {
    ...
    //소수점을 뺀 후 7자리 숫자까지는 거의 정상적으로 저장된다. 7자리이하는 4byte 사용
    ...
    System.out.println(987654321.1234567f);   //값이 왜곡된다. 출력값은 9876540.E8은 10의 8승
    System.out.println(9.876543211234567f);
    System.out.println(987654321123456.7f);
    System.out.println("----------------------------");

    //## 8byte(double) 부동소수점의 유효자릿수
    //소수점을 뺀 후 16자리 숫자까지는 거의 정상적으로 저장된다. 약간의 오차는 발생
    System.out.println(987654321.1234567);    // 7자리 넘어가면8byte 사용하기!!!
