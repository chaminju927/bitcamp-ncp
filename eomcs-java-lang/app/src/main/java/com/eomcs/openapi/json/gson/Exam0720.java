...
public class Exam0720 {
  public static void main(String[] args) {
    ...
    Object v1 = map.get("no");  //맵에서 꺼낸 데이터 타입
    Object v2 = map.get("title");
    Object v3 = map.get("manager");

    System.out.println(v1.getClass().getName()); //double객체
    System.out.println(v2.getClass().getName()); //string 객체
    System.out.println(v3.getClass().getName()); //linkedTreeMAp객체
